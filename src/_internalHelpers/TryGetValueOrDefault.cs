...
namespace JasonPereira84.Helpers
{
    ...
    {
        public static Boolean TryGetValueOrDefault<TValue>(this IDictionary<String, Object> dictionary, String key, out TValue value, Func<Object, TValue> valuefier, TValue defaultValue = default(TValue))
        {
            if (Extensions.Misc.TryGetValueOrDefault(dictionary, key, default, out Object obj))
            {
        ...
        public static TValue GetValueOrDefault<TValue>(this IDictionary<String, Object> dictionary, String key, out TValue value, Func<Object, TValue> valuefier, TValue defaultValue = default(TValue))
        {
            TryGetValueOrDefault(dictionary, key, out value, valuefier, defaultValue);
            return value;
        }

        public static TValue GetValueOrDefault<TValue>(this IDictionary<String, Object> dictionary, String key, Func<Object, TValue> valuefier, TValue defaultValue = default(TValue))
            => GetValueOrDefault(dictionary, key, out TValue value, valuefier, defaultValue);
